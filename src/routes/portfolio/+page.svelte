...
<div class="grid md:grid-cols-2 gap-4">
    <article class="flex flex-col shadow-lg rounded-xl p-4 lg:p-2 xl:p-4 border-gray-50 border-4 dark:bg-gray-600 dark:border-gray-600">
        ...
        <a href="https://github.com/ianprice943" aria-label="Ian's GitHub" class="flex h-full justify-center rounded-xl bg-gray-600 dark:bg-transparent">
            <img src="/images/GitHub_Logo_White.webp" alt="GitHub Logo" class="my-auto" />
        </a>
    </article>
    <article class="shadow-lg rounded-xl p-4 lg:p-2 xl:p-4 border-gray-50 border-4 dark:bg-gray-600 dark:border-gray-600">
        ...
        <a href="https://ip-threejs-playground.netlify.app/" aria-label="A website showing off some basics of Three.js" class="flex my-auto justify-center">
    ...
    <article class="flex flex-col shadow-lg rounded-xl p-4 lg:p-2 xl:p-4 border-gray-50 border-4 dark:bg-gray-600 dark:border-gray-600">
        ...
        <a href="https://wkmediation.com/" aria-label="Website for a mediator in Los Angeles" class="flex h-full justify-center">
